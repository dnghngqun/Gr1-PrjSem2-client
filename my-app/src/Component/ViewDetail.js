    ...
    return (
        <div className="toeic-container">
                ...
                <div className="goal">
                    <div className="goal-detail">
                        <div className="goal-detail1">
                            ...
                            <p>
                                Students will obtain a TOEIC certificate at 110 within 2 months
                                after the course ends (to ensure sufficient knowledge retention
                                for the exam, a free 100% retake is offered if the result is
                                below 550).
                            </p>
                            <p>
                        ...
                        <div className="goal-detail2">
                            ...
                            <p>
                                ...
                                students will quickly expand their vocabulary. After the course,
                                students typically achieve a score of 550+. This vocabulary set
                                is compiled from ETS TOEIC exam materials to facilitate
                                learning.
                            </p>
                        </div>
                    </div>
            ...
            <div className="course-details">
                ...
                <div className="details-list">
                    <div className="details-list1">
                        <h2>27 lessons-2 months a week</h2>
                        <ul>
                ...
                <table className="content-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                Practice part 1<br />
                                People description pictures<br />
                                Object description pictures<br />
                                Mixed pictures
                            </td>
                        </tr>
                        <tr>
            ...
            <div className="sign-course">
                <h2 style={{ color: '#127c71' }}>Course</h2>
