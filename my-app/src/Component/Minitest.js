...
const questions = [
    {
        questionText: 'Which of the following sentences is in the present perfect tense?',
        answerOptions: [
      ...
      {
        questionText: 'Choose the correct form of the verb to complete the sentence: "If I ___ you, I would apologize."',
        answerOptions: [
      ...
      {
        questionText: 'What is the correct form of the adjective in the sentence: "This book is ___ than that one."',
        answerOptions: [
      ...
      {
        questionText: 'Which word correctly completes the sentence: "Neither the teacher ___ the students knew the answer."',
        answerOptions: [
...
const Minitest = () => {
  ...
  useEffect(() => {
    if (showScore) {
      navigate('/result', { state: { score, totalQuestions: questions.length, questions, userAnswers } });
    }
